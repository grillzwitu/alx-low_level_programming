 ...
 *
 * Return: pointer to the new table, or NULL if failure
 */
 ...
 *
 * Description: makes a node for the sorted hash table
 *
 ...
 *
 * Description: add a node to the sorted (by key's ASCII) linked list
 *
 * Return: void
 */
 ...
 * @value: data to add
 *
 * Description: sets a key to a value in the hash table
 *
 ...
 * @key: key to the data
 *
 * Description: retrieve a value from the hash table
 *
 ...
 *
 * Description: prints a sorted hash table
 *
 * Return: void
 */
 ...
 * @ht: hash table to print
 *
 * Description: prints a sorted hash table in reverse
 *
 * Return: void
 */
 ...
 *
 * Description: deletes a sorted hash table
 *
 * Return: void
 */
